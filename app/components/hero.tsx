    ...
    <section className="py-16  md:pt-[123px] md:pb-[156px]">
      <div className="container flex justify-center items-center flex-col">
        ...
        <a
          ...
          target="_blank"
          className="bg-linear-to-r from-[#161A31] to-[#06091F] border-header flex justify-center items-center gap-2.5  w-full md:w-[256px] h-[66px]  font-medium text-white text-[18px] leading-[120%] tracking-[-0.48px] mt-[30px]"
