      ...
      <section className="container">
        ...
        <div className="grid grid-cols-1 items-stretch md:grid-cols-2 gap-10 pt-[60px] pb-[150px]">
          <ProjectCard
            ...
            description="
          Landing page moderna para uma loja de móveis, com design minimalista e visual elegante.
          Apresenta produtos, diferenciais e depoimentos em uma interface limpa e atraente.
        "
            techs={[
              {
                id: "html",
          ...
          <ProjectCard
            ...
            description="
          Landing page inspirada no iFood, com interface moderna e foco em experiência e usabilidade.
        "
            techs={[
              {
                id: "nextjs",
